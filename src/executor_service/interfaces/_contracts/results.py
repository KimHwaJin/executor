"""Aggregated Execution and Operation Result transport contracts."""

from uuid import UUID

from executor_service.application.execution_queries import ExecutionDetailView
...
from executor_service.interfaces._contracts.artifacts import (
    ExecutionArtifactSummaryResponse,
)
from executor_service.interfaces._contracts.attempts import (
...
from executor_service.interfaces._contracts.executions import (
    ExecutionCommandState,
)
from executor_service.interfaces._contracts.operations import (
    OperationResult,
