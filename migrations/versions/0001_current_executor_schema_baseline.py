"""current executor schema baseline

Revision ID: 0001
Revises:
Create Date: 2026-08-12 13:46:23.388450
"""
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "created_by_type",
            sa.Enum("USER", "BATCH", name="actor_type", native_enum=False, length=32),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "mode",
            sa.Enum("STATIC", "DYNAMIC", name="execution_mode", native_enum=False, length=32),
            nullable=False,
        ),
        sa.Column(
            "trigger_type",
        ...
        sa.Column("dynamic_finish_requested", sa.Boolean(), nullable=False),
        ...
        sa.CheckConstraint(
            "failure_type IS NULL OR failure_type IN ('TOOL_ERROR', 'INFRASTRUCTURE_ERROR', 'WORKER_SHUTDOWN', 'RUNTIME_UNAVAILABLE', 'LEASE_EXPIRED', 'INTERNAL_ERROR', 'DYNAMIC_WAIT_TIMEOUT', 'EXECUTION_TIMEOUT', 'RUNTIME_SESSION_LOST')",
            name=op.f("ck_executions_valid_failure_type"),
        ),
        sa.CheckConstraint(
            "mode IN ('STATIC', 'DYNAMIC')", name=op.f("ck_executions_valid_execution_mode")
        ),
        sa.CheckConstraint(
    ...
    op.create_table(
        ...
        sa.Column("execution_plan_id", sa.String(length=255), nullable=False),
        sa.Column("plan_step_id", sa.String(length=255), nullable=False),
    ...
    op.create_index(
        op.f("ix_execution_steps_plan_step_id"), "execution_steps", ["plan_step_id"], unique=False
    )
    op.create_table(
